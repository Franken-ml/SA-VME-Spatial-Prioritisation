...
print(paste("Number of filtered targets:", nrow(filtered_targets)))

# Verify lengths match
if (length(filtered_targets$target) != length(names_features)) {
  stop(sprintf("Mismatch in lengths: features=%d, targets=%d",
               length(names_features),
